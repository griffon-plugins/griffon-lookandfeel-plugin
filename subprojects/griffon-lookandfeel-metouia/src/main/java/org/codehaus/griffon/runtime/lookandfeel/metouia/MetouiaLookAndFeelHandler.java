 ...
 */
package org.codehaus.griffon.runtime.lookandfeel.metouia;
 ...
 */
@Named("metouia")
public class MetouiaLookAndFeelHandler extends AbstractLookAndFeelHandler {
    private final LookAndFeelDescriptor[] supportedDescriptors;

    public MetouiaLookAndFeelHandler() {
        this.supportedDescriptors = new LookAndFeelDescriptor[]{
            new MetouiaLookAndFeelDescriptor()
        };
    }
    ...
    public boolean handles(@Nonnull LookAndFeelDescriptor descriptor) {
        ...
        return descriptor instanceof MetouiaLookAndFeelDescriptor;
    }
    ...
    private static class MetouiaLookAndFeelDescriptor extends DefaultLookAndFeelDescriptor {
        public MetouiaLookAndFeelDescriptor() {
